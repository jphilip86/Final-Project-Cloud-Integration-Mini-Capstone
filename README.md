...
| File                        | Purpose                         |
| --------------------------- | ------------------------------- |
| `use_case.md`             | Healthcare problem & workflow   |
| `architecture_plan.md`    | Cloud services & implementation |
| `architecture_diagram.md` | System architecture visuals     |
| `reflection.md`           | Design analysis & alternatives  |
| `prototype/`              | Working Flask application       |

**Bonus files**:

- `architecture_diagram.md` - Enterprise microservices design
- `architecture_plan.md` - Production deployment (8-week plan)
